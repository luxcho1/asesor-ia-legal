...
<div class="container">
    <div class="row" style="text-align: center">
        <h1>Estos son nuestros abogados especialistas en Familiar</h1>
    </div>

    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
        @foreach ($abogados as $abogado)
            @if ($abogado->especialidad === 'Familiar')
    ...
    <div class="row">
        <div class="col-12 text-center mt-4">
            <a href="{{ url('/chatbot/familiar') }}" class="btn btn-warning btn-lg">Regresar al chatbot</a>
        </div>
    </div>
</div>
</body>
