            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 visually-hidden col-form-label text-md-end">{{ __('Email Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 visually-hidden col-form-label text-md-end">{{ __('Confirm Password') }}</label>
