        ...
        <div class="col-md-8">
            <div class="card shadow-lg">
                ...
                <div class="card-footer">
                    <form action="{{ route('chatbot.penal') }}" method="POST" class="d-flex">
                        @csrf
            ...
            <div class="card shadow-sm" style="width: 22rem; border-radius: 12px; overflow: hidden;">
              ...
              <div class="card-body text-center">
                <p class="card-text text-muted mb-4">
                  ¿Quieres conocer a nuestros primeros abogados especialistas en asesoría penal?
                </p>
                <a href="{{ url('/recomendacion/penal') }}" class="btn btn-outline-primary">
                  Más Información
                </a>
              </div>
            </div>
