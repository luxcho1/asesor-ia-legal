...
class ChatbotEconomicoController extends Controller
{
    public function submit(Request $request)
    {
        ...
        $messages = [
            ...
            Si la pregunta no tiene relación con las leyes o decretos chilenos economicos, responde de manera natural con un mensaje como: 
            "Lo siento, solo puedo ayudarte con temas relacionados con la legislación chilena economica."
            Cuando respondas a las consultas legales economicas, procura que tus respuestas sean breves, claras y precisas, enfocándote en los puntos clave y la mejor orientación legal posible.'],
